...
payasos=int(input("¿Cuántos payasos lleva el paquete?"))
muñecas=int(input("¿Cuántas muñecas lleva el paquete?"))

print('El peso total del paquete es', payasos*pesoPayaso + muñecas*pesoMuñeca, "gramos" )