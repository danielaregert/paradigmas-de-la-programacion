...
# La cantidad de dinero conseguida en cada nivel es de 20.400$ multiplicada por la puntuación 
# del nivel. Escribir un programa que lea la puntuación del empleado e indique su nivel de
# rendimiento, así como la cantidad de dinero que recibirá el empleado.
